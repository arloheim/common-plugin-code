...
public final class Cuboid
{
  ...
  public static Cuboid around(Location center, int radius)
  {
    if (center == null)
  ...
  // Return the minimal corner of the cuboid
  ...
  // Return the maximal corner of the cuboid
  ...
  public Stream<Block> blocksStream()
  {    
    return this.locationsStream()
      .map(l -> l.getBlock());
  }
